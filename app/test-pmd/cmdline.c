                                 ...
                                 __attribute__((unused)) void *data)
{
	...
	if (show_all || !strcmp(res->section, "ports")) {
		...
		cmdline_printf(
			...
			"ether|port|vxlan|geneve|nvgre|vxlan-gpe|mpls|none|<flowtype_id>)\n"
			"    Set the RSS mode.\n\n"
...
cmdline_parse_inst_t cmd_config_rss = {
	...
	.help_str = "port config all rss "
		"all|default|ip|tcp|udp|sctp|ether|port|vxlan|geneve|"
		"nvgre|vxlan-gpe|mpls|none|<flowtype_id>",
	.tokens = {
...
cmdline_parse_token_string_t cmd_config_rss_hash_key_rss_type =
	TOKEN_STRING_INITIALIZER(struct cmd_config_rss_hash_key, rss_type,
				 ...
				 "l3-src-only#l3-dst-only#l4-src-only#l4-dst-only#mpls");
