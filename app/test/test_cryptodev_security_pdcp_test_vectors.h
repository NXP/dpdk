...
static const struct pdcp_short_mac_test list_pdcp_smac_tests[] = {
	{
		...
		.auth_key = (uint8_t[]){ 0x2b, 0xd6, 0x45, 0x9f, 0x82, 0xc5, 0xb3, 0x00,
					 0x95, 0x2c, 0x49, 0x10, 0x48, 0x81, 0xff, 0x48 },
		.data_in = (uint8_t[]){ 0x33, 0x32, 0x34, 0x62, 0x63, 0x39, 0x38 },
		.in_len = 7,
		.data_out = (uint8_t[]){ 0x33, 0x32, 0x34, 0x62, 0x63, 0x39, 0x38, 0x56, 0xd2, 0x09, 0xae },
	},

	{
		...
		.auth_key = (uint8_t[]){ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
					 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.data_in = (uint8_t[]){ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.in_len = 7,
		.data_out = (uint8_t[]){ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x13, 0xf8, 0x4b, 0xea },
	},

	{
		...
		.auth_key = (uint8_t[]){ 0x16, 0xc1, 0x98, 0x14,  0x9a, 0x2c, 0xf4, 0x12,
					 0x4f, 0xd4, 0x14, 0xec, 0x72, 0x43, 0x29, 0x04 },
		.data_in = (uint8_t[]){ 0x00, 0xc0, 0x00, 0x00, 0x00, 0x05, 0x09, 0xe4 },
		.in_len = 8,
		.data_out = (uint8_t[]){ 0x00, 0xc0, 0x00, 0x00, 0x00, 0x05, 0x09, 0xe4, 0xdd, 0xff, 0xde, 0xa9 },
	},

	{
		...
		.auth_key = (uint8_t[]){ 0xD3, 0xC5, 0xD5, 0x92, 0x32, 0x7F, 0xB1, 0x1C,
					 0x40, 0x35, 0xC6, 0x68, 0x0A, 0xF8, 0xC6, 0xD3 },
		.data_in = (uint8_t[]){ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.in_len = 7,
		.data_out = (uint8_t[]){ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x23, 0xea, 0x95, 0xb0 },
	},

	{
		...
		.data_in = (uint8_t[]){ 0x33, 0x32, 0x34, 0x62, 0x63, 0x39, 0x38 },
		.in_len = 7,
		.data_out = (uint8_t[]){ 0x33, 0x32, 0x34, 0x62, 0x63, 0x39, 0x38, 0x00, 0x00, 0x00, 0x00 },
	},
