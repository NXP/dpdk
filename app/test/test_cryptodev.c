...
test_IPSEC_PROTO_all(void)
{
	...
	status = test_IPSEC_LOOKASIDE_PROTOCOL_encrypt_aes_sha1_64B();
	status += test_IPSEC_LOOKASIDE_PROTOCOL_decrypt_aes_sha1_64B();
	status += test_IPSEC_LOOKASIDE_PROTOCOL_encrypt_aes_sha1_64B_oop();
	status += test_IPSEC_LOOKASIDE_PROTOCOL_decrypt_aes_sha1_64B_oop();
	status += test_IPSEC_LOOKASIDE_PROTOCOL_encrypt_aes_64B();
