...
static int
test_DES_cipheronly_dpaa_sec_all(void)
{
	struct crypto_testsuite_params *ts_params = &testsuite_params;
	int status;
...
static struct unit_test_suite cryptodev_dpaa_sec_testsuite  = {
	...
	.unit_test_cases = {
		...
		TEST_CASE_ST(ut_setup, ut_teardown,
			     test_DES_cipheronly_dpaa_sec_all),
		TEST_CASE_ST(ut_setup, ut_teardown,
...
test_cryptodev_qat_raw_api(void /*argv __rte_unused, int argc __rte_unused*/)
{
	...
	ret = unit_test_suite_runner(&cryptodev_qat_testsuite);
...
test_cryptodev_dpaa2_sec_raw_api(void)
{
	...
	global_api_test_type = CRYPTODEV_RAW_API_TEST;
	ret = unit_test_suite_runner(&cryptodev_dpaa2_sec_testsuite);
	global_api_test_type = CRYPTODEV_API_TEST;
