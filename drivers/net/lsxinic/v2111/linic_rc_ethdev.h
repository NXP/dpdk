...
#ifndef _LINIC_RC_ETHDEV_H_
#define _LINIC_RC_ETHDEV_H_
...
void lxsnic_v2111_pf_host_init(struct rte_eth_dev *eth_dev);

void lxsnic_v2111_disable_sriov(struct lxsnic_adapter *adapter);

#endif /* _LINIC_RC_ETHDEV_H_ */
