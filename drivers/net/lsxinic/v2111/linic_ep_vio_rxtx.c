...
void lsxvio_dev_v2111_rx_tx_bind(struct rte_eth_dev *dev)
{
	struct lsxvio_queue *txq;
	struct lsxvio_queue *rxq;
	uint16_t i, num;
...
void lsxvio_dev_v2111_rx_stop(struct rte_eth_dev *dev)
{
	struct lsxvio_queue *rxq;
	uint16_t i;
...
void lsxvio_dev_v2111_tx_stop(struct rte_eth_dev *dev)
{
	struct lsxvio_queue *txq;
	uint16_t i;
