...
#ifndef _LINIC_EP_VIO_RXTX_H_
#define _LINIC_EP_VIO_RXTX_H_
...
void
lsxvio_dev_v2111_rx_tx_bind(struct rte_eth_dev *dev);
void
lsxvio_dev_v2111_rx_stop(struct rte_eth_dev *dev);
void
lsxvio_dev_v2111_tx_stop(struct rte_eth_dev *dev);
uint16_t
lsxvio_v2111_xmit_pkts(void *tx_queue,
	struct rte_mbuf **tx_pkts, uint16_t nb_pkts);
uint16_t
lsxvio_v2111_recv_pkts(void *rx_queue,
	struct rte_mbuf **rx_pkts, uint16_t nb_pkts);
void
lsxvio_dev_v2111_tx_init(struct rte_eth_dev *dev);
int
lsxvio_dev_v2111_rx_init(struct rte_eth_dev *dev);
void
lsxvio_dev_v2111_clear_queues(struct rte_eth_dev *dev);
int
lsxvio_dev_v2111_tx_queue_setup(struct rte_eth_dev *dev,
	uint16_t queue_idx,
	uint16_t nb_desc,
	unsigned int socket_id,
	const struct rte_eth_txconf *tx_conf);
int
lsxvio_dev_v2111_rx_queue_setup(struct rte_eth_dev *dev,
	uint16_t queue_idx,
	uint16_t nb_desc,
	unsigned int socket_id,
...
void
lsxvio_dev_v2111_tx_queue_release(void *txq);
void
lsxvio_dev_v2111_rx_queue_release(void *rxq);
#endif /*_LINIC_EP_VIO_RXTX_H_*/
