...
#ifndef _LINIC_RC_RXTX_H_
#define _LINIC_RC_RXTX_H_
...
uint16_t
lxsnic_v2111_eth_xmit_pkts(void *tx_queue,
	struct rte_mbuf **tx_pkts,
	uint16_t nb_pkts);
uint16_t
lxsnic_v2111_eth_recv_pkts(void *rx_queue,
	struct rte_mbuf **rx_pkts,
	uint16_t nb_pkts);

#endif /* _LINIC_RC_RXTX_H_ */
