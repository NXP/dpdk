...
#ifndef _LINIC_EP_RXTX_H_
#define _LINIC_EP_RXTX_H_
...
uint16_t lsinic_dev_v2111_rx_stop(struct rte_eth_dev *dev,
	int force);
uint16_t lsinic_dev_v2111_tx_stop(struct rte_eth_dev *dev,
	int force);
void
lsinic_dev_v2111_rx_enable_start(struct rte_eth_dev *dev);
void
lsinic_dev_v2111_tx_enable_start(struct rte_eth_dev *dev);
int
