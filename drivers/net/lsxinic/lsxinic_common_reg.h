...
struct __rte_packed_begin lsinic_bd_desc {
...
struct __rte_packed_begin lsinic_rc_rx_len_idx {
	union {
		uint32_t len_idx;
		struct {
			/* For CB buffer, length excludes CB header.*/
...
struct __rte_packed_begin lsinic_ep_tx_dst_addrl {
	uint32_t pkt_addr_low;
} __rte_packed_end;

struct __rte_packed_begin lsinic_ep_tx_dst_addrx {
...
struct __rte_packed_begin lsinic_ep_rx_src_addrl {
	union {
...
struct __rte_packed_begin lsinic_ep_rx_src_addrx {
	union {
