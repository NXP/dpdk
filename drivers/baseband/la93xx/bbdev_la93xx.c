...
RTE_EXPORT_EXPERIMENTAL_SYMBOL(rte_pmd_la93xx_get_nlm_mem, 25.11)
mem_range_t *
...
RTE_EXPORT_EXPERIMENTAL_SYMBOL(rte_pmd_get_pps_out_count, 25.11)
...
RTE_EXPORT_EXPERIMENTAL_SYMBOL(rte_pmd_la93xx_reset, 25.11)
int
...
RTE_EXPORT_EXPERIMENTAL_SYMBOL(rte_pmd_la93xx_reset_restore_cfg, 25.11)
int
